...
import os
filepath=os.path.abspath(__file__) #mention the current filepath so that it can be distributed in multiple machines.
print(filepath)
t = DistributeScan(x=x, y=y, params=p, model=diabetes, experiment_name=exp_name,
                         file_path=filepath,
                         destination_path="./three.py")
t.distributed_run()
